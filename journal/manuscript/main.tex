...
&\quad + (1 - \gamma(s_B))\,\exp\left(-\mathcal{D}_{\mathcal{W}}^2(A, B)\right)
\end{split}
\end{equation}
...
&= \gamma(s_B)\,\mathcal{L}_{\text{IoU}}(A, B) \nonumber \\
&\quad + (1 - \gamma(s_B))\,\mathcal{L}_{\mathcal{W}}(A, B)
\end{align}
