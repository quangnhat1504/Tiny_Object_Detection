...
from . import alw, igwd, iou, nwd, sa_alw, sa_alw_canonical, h_wiou
...
def configure_metric(
    ...
    *,
    ...
    schedule = {
        "s_min": 2.0 if s_min is None else s_min,
        "s_max": 32.0 if s_max is None else s_max,
        "beta_min": 4.0 if beta_min is None else beta_min,
        "beta_max": 12.0 if beta_max is None else beta_max,
        "w_min": 0.5 if w_min is None else w_min,
        "w_max": 2.0 if w_max is None else w_max,
    }
