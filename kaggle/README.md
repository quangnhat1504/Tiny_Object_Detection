...
```bash
!python scripts/kaggle_run.py --run smooth_l1_ap75 --data-root /kaggle/input/tinydataset-yolostandard
```

Account/notebook 2, reduced oversampling:

```bash
!python scripts/kaggle_run.py --run os1 --data-root /kaggle/input/tinydataset-yolostandard
```

Account/notebook 3, light copy-paste:

```bash
!python scripts/kaggle_run.py --run cp_light --data-root /kaggle/input/tinydataset-yolostandard
```
...
```bash
!python scripts/kaggle_run.py --run smooth_l1_ap75 --skip-train --data-root /kaggle/input/tinydataset-yolostandard
```
