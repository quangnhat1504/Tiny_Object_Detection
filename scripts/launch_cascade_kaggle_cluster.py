...
Uses battle-tested Jupyter Notebook format with dependency pre-installation and output preservation.
"""
...
CASCADE_EXPS = [
    {
        "tag": "aitod_cascade_homotopy_s42_proposed",
        "slug": "tod-cascade-homotopy-s42-proposed",
        "title": "tod-cascade-homotopy-s42-proposed",
        "account": "luongsythanh",
        "cred": CREDS_DIR / "kaggle (8).json",
        "cmd": "python scripts/train_cascade_aitod.py --sigmas 8.0 4.0 2.0 --seed 42 --epochs 12 --batch-size 4 --tag cascade_homotopy_s42",
    },
    {
        ...
        "cmd": "python scripts/train_frcnn_aitod.py --metric standard --placement everywhere --box-loss smooth_l1 --batch-size 4 --seed 42 --epochs 12 --rpn-cascade --tag cascade_baseline_s42",
    },
    {
        "tag": "aitod_rfla_hwiou_s42_proposed",
        "slug": "tod-rfla-hwiou-s42-proposed",
        "title": "tod-rfla-hwiou-s42-proposed",
        "account": "qnhat1504",
        "cred": CREDS_DIR / "kaggle (3).json",
        "cmd": "python scripts/train_frcnn_aitod.py --metric rfla --placement la_loss --box-loss h_wiou --h-wiou-sigma-0 8.0 --batch-size 4 --seed 42 --epochs 12 --tag rfla_hwiou_s42",
    },
    {
        "tag": "aitod_rfla_baseline_s42",
        "slug": "tod-rfla-baseline-s42",
        "title": "tod-rfla-baseline-s42",
        "account": "thyngluthy",
        "cred": CREDS_DIR / "kaggle (4).json",
        "cmd": "python scripts/train_frcnn_aitod.py --metric rfla --placement la_loss --box-loss smooth_l1 --batch-size 4 --seed 42 --epochs 12 --tag rfla_baseline_s42",
    },
]
...
def main():
    print("=" * 80)
    print("   LAUNCHING CASCADE MULTI-STAGE HOMOTOPY & RFLA EXPERIMENTS ON KAGGLE   ")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("   ALL 4 CASCADE & RFLA JOBS DISPATCHED TO KAGGLE CLUSTER SUCCESSFULLY!   ")
    print("=" * 80)
