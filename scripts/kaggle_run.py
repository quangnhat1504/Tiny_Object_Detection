...
RUNS = {
    ...
    "cbl_iterative_train_local_gate": {
        "env": {
            "TOD_EPOCHS": "2",
            "TOD_USE_EMA": "0",
            "TOD_NUM_WORKERS": "0",
        ...
        "train": [
            ...
            "--tag", "cbl_iterative_train_local_gate",
        ],
        "ckpt": (
            "runs/sa_alw_full__cbl__irtw0.5ir1s0.3__la_loss__seed42"
            "__cbl_iterative_train_local_gate/best_ap75.pt"
        ),
        "analysis": "runs/ap75_analysis_cbl_iterative_train_local_gate_valid",
    },
    "cbl_iterative_train_w025_local_gate": {
        "env": {
            "TOD_EPOCHS": "2",
            "TOD_USE_EMA": "0",
            "TOD_NUM_WORKERS": "0",
        ...
        "train": [
            ...
            "--box-loss", "cbl",
            "--box-loss-warmup-epochs", "0",
            "--cbl-refine-train-weight", "0.25",
            "--cbl-refine-steps", "1",
            "--cbl-refine-blend", "1.0",
            "--cbl-refine-score-threshold", "0.3",
            "--tag", "cbl_iterative_train_w025_local_gate",
        ],
        "ckpt": (
            "runs/sa_alw_full__cbl__irtw0.25ir1s0.3__la_loss__seed42"
            "__cbl_iterative_train_w025_local_gate/best_ap75.pt"
        ),
        "analysis": (
    ...
    "cbl_iterative_train_ema8": {
        ...
        "train": [
            ...
            "--cbl-refine-blend", "1.0",
            "--cbl-refine-score-threshold", "0.3",
            "--tag", "cbl_iterative_train_ema8",
        ],
        "ckpt": (
            "runs/sa_alw_full__cbl__irtw0.5ir1s0.3__la_loss__seed42"
            "__cbl_iterative_train_ema8/best_ap75.pt"
        ),
