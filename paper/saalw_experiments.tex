...
$1{,}374/131/65$ for train/val/test. The $\sqrt{\text{area}}$ has mean
$15.7$\,px and median $11.5$\,px; $79.5\%$ and $92.1\%$ of instances are
smaller than $20$\,px and $32$\,px (Table~\ref{tab:exp-eda}). The class
distribution is $1.9:1$ (\texttt{dry-person} favored). Notably, $43.6\%$
of \texttt{dry-person} instances have aspect ratio below $0.5$, motivating
anisotropic normalization in ALW and SA-ALW.

\begin{table}[t]
\centering
\caption{\texorpdfstring{Object-size distribution by $\sqrt{\text{area}}$ bin.}{Object-size distribution.}}
\label{tab:exp-eda}
\small
\begin{tabular}{lrr}
\toprule
...
All Faster R-CNN experiments share a byte-identical training harness with
...
\begin{table*}[t]
\centering
\caption{\texorpdfstring{Test-set evaluation (locked, $65$ images). Standard
COCO metrics. Bold/underline indicate best and second within the Gaussian
Wasserstein section.}{Test-set evaluation.}}
...
IGWD~\cite{igwd2024}           & 0.0874 & 0.2642 & 0.0371 & 0.0751 & \textbf{0.2048} & 0.4773 & 0.2318 \\
